...
const formatSalaryLPA = (salary) => {
  ...
  <div className="flex flex-col mt-4">
    ...
    <p className="text-sm mt-1">{job.description.slice(0, 120)}....</p>

    <div className="flex mt-4 gap-5 text-sm ">
      <b className="bg-slate-100 text-blue-400 rounded-sm shadow-sm  ">{job.jobType}</b>
      <b className="bg-slate-100 text-red-400 rounded-sm shadow-sm ">{formatSalaryLPA(job.salary)}</b>
      <b className="bg-slate-100 text-purple-600 rounded-sm shadow-sm ">
